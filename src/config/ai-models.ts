...
export type ModelProvider = 'anthropic' | 'openai' | 'google' | 'deepseek' | 'moonshotai';
...
export const MODEL_REGISTRY = [
  ...
  },
  {
    ...
    minPlan: UserPlan.PRO,
    creditFloor: 3,
    description: 'Cost-efficient Moonshot Kimi model for coding and multi-file edits.',
    capabilities: { supportsTools: true, supportsLongContext: true },
  },
  {
    ...
    creditFloor: 3,
    isNew: true,
    description: 'Updated Moonshot Kimi model with stronger reasoning for app work.',
    capabilities: { supportsTools: true, supportsLongContext: true },
  },
  {
    ...
    creditFloor: 4,
    isNew: true,
    description: 'Code-specialized Moonshot Kimi model for agentic multi-file builds.',
    capabilities: { supportsTools: true, supportsToolCalling: true, supportsLongContext: true },
  },
  {
...
export const PROVIDER_META: Record<ModelProvider, {
  ...
  moonshotai: { label: 'Moonshot', color: '#1F1F1F', textColor: '#fff', icon: 'moonshotai' },
};
