export const HUGGY_MESSAGE_STREAMING_PROMPT_VERSION = 'huggy-message-streaming-prompt-v1';
...
export const HUGGY_STRUCTURED_MESSAGE_STREAMING_CONTRACT = [
  ...
  'Stop must cancel client rendering and request server cancellation when supported.',
