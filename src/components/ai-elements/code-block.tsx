...
// Legacy export — preserved so existing importers keep working unchanged.
export function CodeBlock({
  ...
  // Enhanced path: when a filename or streaming flag is provided, render the v2
  // card (copy button + streaming cursor). Otherwise keep the minimal legacy
  // markup so nothing that relied on the old output changes.
